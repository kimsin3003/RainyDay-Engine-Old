...
void UISprite::SetToRect()
{
	...
	Vertex v1 = { pos[0], rgba, normal,{ 0.0f, 0.0f } };
	Vertex v2 = { pos[1], rgba, normal,{ 1.0f, 0.0f } };
	Vertex v3 = { pos[2], rgba, normal,{ 1.0f, 1.0f } };
	Vertex v4 = { pos[3], rgba, normal,{ 0.0f, 1.0f } };
...
void UISprite::SetToNumber(int n)
{
	...
	Vertex v1 = { pos[0], rgba, normal,{ startTexPos, 0.0f } };
	Vertex v2 = { pos[1], rgba, normal,{ finishTexPos, 0.0f } };
	Vertex v3 = { pos[2], rgba, normal,{ finishTexPos, 1.0f } };
	Vertex v4 = { pos[3], rgba, normal,{ startTexPos, 1.0f } };
